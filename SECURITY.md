...
Replace all {{PLACEHOLDER}} values with your information:
  Metadata Grammar     - Your project name
  hyperpolymath            - GitHub username or org (e.g., hyperpolymath)
  metadata-grammar             - Repository name
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/metadata-grammar/security/advisories/new)
...
- This repository (`hyperpolymath/metadata-grammar`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/metadata-grammar/security/advisories)
...
When using Metadata Grammar, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/metadata-grammar/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/metadata-grammar/security/advisories/new) or 6759885+hyperpolymath@users.noreply.github.com |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/metadata-grammar/discussions) |
...
*Thank you for helping keep Metadata Grammar and its users safe.* 🛡️
