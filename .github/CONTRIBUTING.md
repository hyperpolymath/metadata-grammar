...
git clone <https://github.com/hyperpolymath/metadata-grammar.git> cd
metadata-grammar
...
toolbox create metadata-grammar-dev toolbox enter metadata-grammar-dev
...
metadata-grammar/ ├── src/ \# Source code (Perimeter 1-2) ├── lib/ \#
...
flake (Perimeter 1) └── Justfile \# Task runner (Perimeter 1)
    ...
    **When suggesting**:
    ...
    - [`good first issue`](https://github.com/hyperpolymath/metadata-grammar/labels/good%20first%20issue) — Simple Perimeter 3 tasks
    - [`help wanted`](https://github.com/hyperpolymath/metadata-grammar/labels/help%20wanted) — Community help needed
    - [`documentation`](https://github.com/hyperpolymath/metadata-grammar/labels/documentation) — Docs improvements
    - [`perimeter-3`](https://github.com/hyperpolymath/metadata-grammar/labels/perimeter-3) — Community sandbox scope
