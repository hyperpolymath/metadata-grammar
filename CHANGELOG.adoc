...
All notable changes to `+metadata-grammar+` will be documented in this
file.
...
* docs: comprehensive documentation update - all files current and
cross-referenced
* docs: complete arXiv position paper draft for Journey Grammar for
Databases
* docs: add Related Work section for arXiv position paper
* docs: enhance philosophy with emerging maps on journeys, add arXiv
paper discussion
