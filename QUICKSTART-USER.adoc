...
// Replace metadata-grammar, Metadata Grammar — See README.adoc for details., just run, Metadata Grammar started successfully. with actuals
= metadata-grammar — Quick Start for Users
:toc:
:toclevels: 2

== What is metadata-grammar?

Metadata Grammar — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./metadata-grammar-portable
----
...
[source]
----
Metadata Grammar started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/metadata-grammar/wiki
