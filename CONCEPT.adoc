...
**verisim**: The cartographic index (atlas)
...
- Registered with verisim, indexed by coverage
...
== Integration with verisim: The Cartographic Index

**verisim** serves as the **atlas** that coordinates exploration of reality.

=== verisim as Cartographic Infrastructure
...
=== Metadata Grammar + verisim Integration

**How they work together**:

1. **metadata-grammar** defines the cartographic standard (how to create maps)
2. **verisim** implements the atlas infrastructure (indexes the maps)
3. **Phenomenal databases** register with verisim using metadata-grammar specs
...
# Cartographic evolution tracked by verisim
...
:MyDataset a mg:Dataset ;
    ...
    mg:license <https://spdx.org/licenses/MPL-2.0> ;
...
- **verisim**: https://github.com/hyperpolymath/verisimdb

== License

This specification is licensed under the Palimpsest Meta-Philosophical License (MPL-2.0).
