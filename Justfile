...
doctor:
    @echo "Running diagnostics for metadata-grammar..."
...
help-me:
    @echo "=== metadata-grammar Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/metadata-grammar/issues/new"
    @echo ""
