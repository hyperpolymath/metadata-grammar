...
[arabic]
. Navigate to
https://github.com/hyperpolymath/metadata-grammar/security/advisories/new[Report
a Vulnerability]
...
https://github.com/hyperpolymath/metadata-grammar/security/advisories[Security
Advisories]
...
|*General questions*
|https://github.com/hyperpolymath/metadata-grammar/discussions[GitHub
Discussions]
...
_Thank you for helping keep Metadata Grammar and its users safe._ 🛡️
